...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板",
    "image_file": "舗装切断.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_description": "舗装切断を4月27日・28日に行います。舗装切断中は、通行止めとなります。迂回路は道路幅が狭くご迷惑をおかけしますが、ご協力をよろしくお願い致します。",
