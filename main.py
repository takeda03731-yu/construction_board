...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月28日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_description": "日頃より、本工事へのご理解とご協力をいただき、誠にありがとうございます。\n\n交通規制や迂回などにより、地域の皆様にはご不便をおかけしておりますが、皆様の温かいご配慮とご協力のおかげで、安全に作業を進めることができております。心より感謝申し上げます。\n\n5月29日（金曜日）は、図に示しております箇所において施工を行う予定としております。\n\n特に今回は、㈱田宮パーツの皆様、大洋印刷㈱の皆様、ならびに施工箇所付近にお住まいの住民様には、車両の出入りや通行等において、通常以上に大きなご不便とご負担をおかけすることとなります。\n\nそのような中でも、日頃より温かいご理解とご協力をいただいておりますこと、心より感謝申し上げます。\n\n皆様のご協力のおかげで、土日での工事を避けながら施工を進めることができております。重ねて御礼申し上げます。\n\n通行止め区間は引き続き一部延長となるため、南側から北側への通り抜けができない状況となります。\n\n通行の際は、現地誘導員の案内に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。\n\nなお、北側からの車両通行につきましても、引き続き制限が続く見込みとなっております。\n\n大型車両につきましては、恐れ入りますが、図に示しております箇所より進入していただきますようお願いいたします。\n\nまた、迂回路は道路幅が狭い箇所もございますので、通行の際は十分ご注意くださいますようお願いいたします。\n\n皆様にはご不便とご負担をおかけいたしますが、安全確保を最優先に作業を進めてまいりますので、何卒ご理解とご協力を賜りますようお願い申し上げます。\n\n今後も安全管理を徹底し、周辺環境に十分配慮しながら施工を進めてまいりますので、引き続きよろしくお願い申し上げます。",
