...
SITE_INFO = {
    ...
    "image_description4": "工事の進捗に伴い、8月24日（月曜日）より、工事業者が移動するゴミの対象範囲を拡大いたします。\n\n現在、「ゴミステーション1」に出されたゴミは、工事業者が「移動先ゴミステーション1」まで移動しております。8月24日（月曜日）からは、これに加えて、「ゴミステーション2」および「ゴミステーション3」に出されたゴミについても、工事業者が「移動先広場2」まで移動いたします。\n\n地域の皆様に、特別なご対応をお願いするものではございません。これまでどおり、所定の時間までに、それぞれのゴミステーションへゴミをお出しください。ゴミの移動は工事業者が行います。\n\n地域の皆様にはご不便をおかけいたしますが、工事の安全かつ円滑な実施のため、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。",
    "holiday_notice": "明日9月2日（水曜日）は、別工事への対応のため、本工事を休工といたします。工事の再開は、9月3日（木曜日）を予定しております。\n\nまた、本工事では、作業員の安全確保と健康管理に加え、建設業界における働き方改革の取り組みの一環として、原則、土曜日および日曜日を休工日としております。\n\n近年、建設業界では、安全で質の高い施工を継続するため、適切な休日を確保しながら工事を進める取り組みが推進されています。本工事におきましても、特別な事情がない限り、土曜日および日曜日の作業は行わない予定です。\n\n地域の皆様には、休工日の設定によりご不便をおかけすることもございますが、安全かつ円滑に工事を進めるため、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。"
}
...
We will do our best to minimize inconvenience and appreciate your cooperation for safe construction work.""",
    ...
    "image_description4": """Due to the progress of the construction work, the area covered by the contractor’s garbage relocation service will be expanded beginning Monday, August 24.\n\nCurrently, garbage placed at “Garbage Collection Point 1” is moved by the construction contractor to “Temporary Garbage Collection Point 1.” Beginning Monday, August 24, garbage placed at “Garbage Collection Point 2” and “Garbage Collection Point 3” will also be moved by the construction contractor to “Temporary Collection Area 2.”\n\nNo special action is required from local residents. Please continue to place your garbage at your usual collection point by the designated collection time. The construction contractor will handle the relocation of the garbage.\n\nWe apologize for any inconvenience this may cause and sincerely appreciate your understanding and cooperation in ensuring that the construction work proceeds safely and smoothly.""",

    "holiday_notice": """Tomorrow, Wednesday, September 2, this construction work will be suspended because our workers are required to attend to another construction project. Work is scheduled to resume on Thursday, September 3.\n\nIn addition, as part of our efforts to ensure the safety and well-being of our workers and to support work-style reforms in the construction industry, Saturdays and Sundays are generally designated as non-working days for this project.\n\nIn recent years, the construction industry has been promoting initiatives to ensure that workers receive appropriate time off while continuing to provide safe, high-quality construction work. Accordingly, no work is generally scheduled on Saturdays or Sundays for this project unless special circumstances require otherwise.\n\nWe understand that these non-working days may cause some inconvenience to local residents. However, they are necessary to ensure that the construction work proceeds safely and smoothly. We sincerely appreciate your understanding and cooperation."""
}
