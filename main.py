...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　8月28日現在",
    "image_file": "給水分岐替工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "日頃より、本工事の実施にあたり、地域の皆様にはご理解とご協力を賜り、誠にありがとうございます。\n\n本日の工事につきましては、朝の時点で雨天が予想されたため、作業の安全を考慮し、休工といたしました。\n\n当日の朝に判断したことから、結果として実際の天候とは異なる状況となりました。地域の皆様をはじめ、作業員、水道企業団およびその他の関係者の皆様には、予定の変更によりご迷惑をおかけしましたことをお詫び申し上げます。\n\n次回は、8月31日（月曜日）に、図に示した給水分岐替工事箇所の「9番」を施工する予定です。\n\n工事に伴い、対象となるご家庭および事業所におきましては、一時的に断水させていただく必要がございます。具体的な断水日時につきましては、対象となる皆様へ事前に個別でお知らせいたします。\n\nまた、交通規制につきましては、当初の規制範囲に戻ります。北側・南側のいずれの方向からも通り抜けができませんので、お車で通行される際は、迂回路をご利用くださいますようお願いいたします。\n\n工事箇所周辺には、皆様の安全な通行を確保するため、交通誘導員を配置いたします。通行の際は、現地の案内看板および交通誘導員の誘導に従っていただきますようお願いいたします。\n\nなお、中型車両につきましても、通行可能な経路が限られております。ご不便をおかけして誠に恐縮ではございますが、目的地に応じた適切な経路をご利用くださいますようお願いいたします。\n\n地域の皆様には、交通規制や一時的な断水により、引き続きご不便をおかけいたします。水道企業団のご指導のもと、関係者一同が連携し、安全を最優先に工事を進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
...
SITE_INFO_EN = {
    "construction_name": "Notice Board for Water Distribution Pipe Replacement Work as of August 28, 2026",
    "image_file": "給水分岐替工en.pdf",
    "image_file2": "工事概要en.pdf",
    "image_file3": "臨時駐車場en.pdf",
    "image_file4": "ゴミの移動en.pdf",

    "image_description": """Thank you to all local residents for your continued understanding and cooperation regarding this construction work.\n\nToday’s construction work was suspended because rain was forecast in the morning, and the decision was made with the safety of the work in mind.\n\nAs the decision was made early in the morning, the actual weather conditions later differed from the forecast. We sincerely apologize to local residents, workers, the water authority, and all other parties concerned for any inconvenience caused by this change in schedule.\n\nThe next construction work is scheduled for Monday, August 31. Water service connection replacement work will be carried out at location No. 9, as shown in the diagram.\n\nAs part of the work, the water supply to the affected households and businesses will need to be temporarily suspended. Those affected will be notified individually in advance of the specific date and time of the water service suspension.\n\nThe traffic restrictions will return to the original restriction area. Through traffic will not be possible from either the north or the south. Drivers are kindly requested to use the designated detour routes.\n\nTraffic control personnel will be stationed around the construction area to ensure everyone’s safety. When passing through the area, please follow the on-site signs and the directions given by the traffic control personnel.\n\nPlease note that the available routes for medium-sized vehicles will also be limited. We apologize for the inconvenience and kindly ask drivers to use the appropriate route for their destination.\n\nWe apologize for the continued inconvenience caused by the traffic restrictions and temporary water service suspension. Under the guidance of the water authority, all parties involved will work together and proceed with the construction while giving the highest priority to safety. We sincerely appreciate your understanding and cooperation.""",
