...
SITE_INFO_EN = {
    "construction_name": "Notice Board for Water Distribution Pipe Replacement Work as of July 9, 2026",
    "image_file": "配水管布設工en.pdf",
    "image_file2": "工事概要en.pdf",
    "image_file3": "臨時駐車場en.pdf",
    "image_file4": "ゴミの移動en.pdf",

    "image_description": """Thank you very much for your continued understanding and cooperation regarding this construction project.\n\nDuring the construction period, we apologize for the inconvenience caused by traffic restrictions and detours. Thanks to your kind understanding and cooperation, we have been able to carry out the work safely. We sincerely appreciate your continued support.\n\nWe would also like to thank you for your cooperation with today's water service interruption in the afternoon.\n\nThanks to your understanding and cooperation, we successfully completed the cutting of the existing water pipe and proceeded with the installation of the new pipeline. Since the work at this location required a temporary water shutdown, we apologize for the inconvenience and sincerely appreciate your support.\n\nTomorrow, Friday, July 10, construction will be carried out in the area shown on the map.\n\nThe traffic restriction area will remain the same as today.\n\nDepending on the time of day, vehicle access from both the north and south sides may be temporarily restricted.\n\nTraffic controllers will be on site to ensure safety. Please follow their instructions and use the designated detour route shown on the map.\n\nWe sincerely appreciate your patience and cooperation throughout this construction period.\n\nWe will continue to place the highest priority on safety and make every effort to minimize the impact on the local community while carrying out the work.\n\nThank you for your continued understanding and cooperation.""",
