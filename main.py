...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月11日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_description": "試掘工の際は、皆様にご理解とご協力を賜り、誠にありがとうございました。\n\nおかげさまで、無事故で円滑に作業を終えることができました。\n\n試掘工により地下埋設物を確認した結果、配水管布設工を実施できる見通しとなりましたので、明日5月12日より本格的に工事を開始いたします。\n\n作業は、図に示しております箇所から順次施工してまいります。\n\n工事に伴い、しばらくの間、北側からの車両の出入りができなくなります。\n\nまた、大型車両につきましては、恐れ入りますが図に示しております箇所から進入していただけますと大変助かります。\n\n迂回路につきましても道路幅が狭く、皆様にはご不便とご負担をおかけいたしますことを、心よりお詫び申し上げます。\n\n安全を最優先に、できる限り円滑に作業を進めてまいりますので、引き続きご理解とご協力をいただけますと幸いです。",
