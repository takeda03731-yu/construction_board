...
SITE_INFO = {
    ...
    "image_description": "平素より、本工事の実施に際し、地域の皆様には温かいご理解とご協力をいただき、心より感謝申し上げます。\n\n本日9月2日（水曜日）は、別工事への対応のため、本工事を休工となりました。\n\n次回は、9月3日（木曜日）に、図に示した箇所の「配水管布設工」ならびに給水分岐替工事箇所の「14番」および「15番」を施工する予定です。\n\n工事に伴い、対象となるご家庭および事業所におきましては、一時的に断水させていただく必要がございます。具体的な断水日時につきましては、対象となる皆様へ事前に個別でお知らせいたします。\n\nまた、交通規制につきましては、以前実施していた規制範囲に戻ります。北側・南側のいずれの方向からも通り抜けができませんので、お車で通行される際は、迂回路をご利用くださいますようお願いいたします。\n\n工事箇所周辺には、皆様の安全な通行を確保するため、交通誘導員を配置いたします。通行の際は、現地の案内看板および交通誘導員の誘導に従っていただきますよう、ご理解とご協力をお願いいたします。\n\nなお、中型車両につきましても、通行可能な経路が限られております。ご不便をおかけして誠に恐縮ではございますが、目的地に応じた適切な経路をご利用くださいますようお願いいたします。\n\n地域の皆様には、交通規制や一時的な断水により、引き続きご不便をおかけいたします。水道企業団をはじめとする関係者一同が緊密に連携し、安全を第一に工事を進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
    ...
    "image_description4": "工事の進捗に伴い、9月3日（木曜日）より、工事業者が移動するゴミの対象範囲を縮小いたします。\n\n9月3日（木曜日）以降は、「ゴミステーション1」に出されたゴミのみ、工事業者が「移動先ゴミステーション1」まで移動いたします。「ゴミステーション2」および「ゴミステーション3」に出されたゴミにつきましては、移動を行わず、それぞれのゴミステーションから通常どおり収集されます。\n\n地域の皆様に特別なご対応をお願いするものではございません。これまでどおり、所定の時間までに、それぞれのゴミステーションへゴミをお出しください。「ゴミステーション1」に出されたゴミの移動は、引き続き工事業者が行います。\n\n地域の皆様にはご不便をおかけいたしますが、工事を安全かつ円滑に進めるため、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。",
    "holiday_notice": "本日9月2日（水曜日）は、別工事への対応のため、本工事を休工となりました。工事の再開は、9月3日（木曜日）を予定しております。\n\nまた、本工事では、作業員の安全確保と健康管理に加え、建設業界における働き方改革の取り組みの一環として、原則、土曜日および日曜日を休工日としております。\n\n近年、建設業界では、安全で質の高い施工を継続するため、適切な休日を確保しながら工事を進める取り組みが推進されています。本工事におきましても、特別な事情がない限り、土曜日および日曜日の作業は行わない予定です。\n\n地域の皆様には、休工日の設定によりご不便をおかけすることもございますが、安全かつ円滑に工事を進めるため、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。"
}
...
SITE_INFO_EN = {
    ...
    "image_description": """We would like to express our sincere appreciation to all local residents for your continued understanding and cooperation regarding this construction work.\n\nToday, Wednesday, September 2, this construction work was suspended because our workers were required to attend to another construction project.\n\nThe next work is scheduled for Thursday, September 3. Water distribution pipeline installation work will be carried out at the location shown in the diagram, along with water service connection replacement work at locations No. 14 and No. 15.\n\nAs part of the work, the water supply to the affected households and businesses will need to be temporarily suspended. Those affected will be notified individually in advance of the specific date and time of the water service suspension.\n\nThe traffic restrictions will return to the area where they were previously in place. Through traffic will not be possible from either the north or the south. Drivers are kindly requested to use the designated detour routes.\n\nTraffic control personnel will be stationed around the construction area to ensure everyone’s safety. When passing through the area, please follow the on-site signs and the directions given by the traffic control personnel.\n\nPlease note that the available routes for medium-sized vehicles will also be limited. We apologize for the inconvenience and kindly ask drivers to use the appropriate route for their destination.\n\nWe apologize for the continued inconvenience caused by the traffic restrictions and temporary water service suspension. The water authority and all other parties involved will work closely together and proceed with the construction while giving the highest priority to safety. We sincerely appreciate your understanding and cooperation.""",
...
We will do our best to minimize inconvenience and appreciate your cooperation for safe construction work.""",
    ...
    "image_description4": """Due to the progress of the construction work, the area covered by the contractor’s garbage relocation service will be reduced beginning Thursday, September 3.\n\nFrom Thursday, September 3, only garbage placed at “Garbage Collection Point 1” will be moved by the construction contractor to “Temporary Garbage Collection Point 1.” Garbage placed at “Garbage Collection Point 2” and “Garbage Collection Point 3” will no longer be relocated and will be collected directly from the usual collection points.\n\nNo special action is required from local residents. Please continue to place your garbage at your usual collection point by the designated collection time. The construction contractor will continue to relocate garbage placed at “Garbage Collection Point 1.”\n\nWe apologize for any inconvenience and sincerely appreciate your understanding and cooperation in ensuring that the construction work proceeds safely and smoothly.""",

    "holiday_notice": """Today, Wednesday, September 2, this construction work was suspended because our workers were required to attend to another construction project. Work is scheduled to resume on Thursday, September 3.\n\nIn addition to ensuring the safety and well-being of our workers, Saturdays and Sundays are generally designated as non-working days for this project as part of work-style reform initiatives in the construction industry.\n\nIn recent years, the construction industry has been promoting initiatives to ensure that workers receive appropriate time off while continuing to provide safe, high-quality construction work. Accordingly, no work is generally scheduled on Saturdays or Sundays for this project unless special circumstances require otherwise.\n\nWe understand that these non-working days may cause some inconvenience to local residents. However, they are necessary to ensure that the construction work proceeds safely and smoothly. We sincerely appreciate your understanding and cooperation."""
}
