...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　8月21日現在",
    "image_file": "給水分岐替工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "日頃より、本工事の実施に際し、地域の皆様には多大なるご理解とご協力を賜り、心より御礼申し上げます。\n\n本日予定しておりました断水作業につきまして、工事中に工事用機械が既設の配水管に接触し、損傷させたことにより、事前にお知らせしていた時刻よりも早く断水となりました。\n\n対象地域の皆様には、突然の断水により多大なるご不便とご迷惑をおかけしましたことを、深くお詫び申し上げます。また、水道企業団をはじめとする関係者の皆様にも、多大なるご迷惑をおかけしましたことを、重ねてお詫び申し上げます。\n\n今後は、このような事態を二度と発生させないよう、既設配水管の位置確認を徹底するとともに、工事用機械による作業方法および安全管理体制を改めて見直し、再発防止に全力で取り組んでまいります。\n\n来週8月24日（月曜日）は、図に示した給水分岐替工事箇所の「21番」および「24番」を施工する予定です。\n\n工事に伴い、対象となるご家庭および事業所におきましては、一時的に断水させていただく必要がございます。具体的な断水日時につきましては、対象となる皆様へ事前に個別でお知らせいたします。\n\nまた、工事に伴う交通規制につきましては、線路付近を中心とした規制範囲に戻ります。北側・南側のいずれの方向からも通り抜けができませんので、お車で通行される際は、迂回路をご利用くださいますようお願いいたします。\n\nなお、中型車両につきましても、通行可能な経路が限られております。ご不便をおかけして誠に申し訳ございませんが、目的地に応じた適切な経路をご利用くださいますようお願いいたします。\n\n地域の皆様には、引き続きご不便とご迷惑をおかけいたしますが、水道企業団のご指導のもと、関係者が緊密に連携し、安全を最優先に工事を進めてまいります。工事の安全かつ円滑な実施に向け、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。",
...
SITE_INFO_EN = {
    "construction_name": "Notice Board for Water Distribution Pipe Replacement Work as of August 21, 2026",
    "image_file": "給水分岐替工en.pdf",
    "image_file2": "工事概要en.pdf",
    "image_file3": "臨時駐車場en.pdf",
    "image_file4": "ゴミの移動en.pdf",

    "image_description": """We would like to express our sincere gratitude to all local residents for your continued understanding and cooperation regarding this construction work.\n\nRegarding today’s scheduled water service suspension, construction machinery accidentally came into contact with and damaged an existing water distribution main during the work. As a result, the water service was suspended earlier than the time previously announced.\n\nWe sincerely apologize to all residents in the affected area for the considerable inconvenience caused by this unexpected water service suspension. We would also like to extend our deepest apologies to the water authority and all other parties concerned for the trouble caused.\n\nTo prevent a similar incident from occurring again, we will thoroughly verify the locations of existing water mains and review our operating procedures for construction machinery and our overall safety management system. We will make every effort to ensure that this does not happen again.\n\nOn Monday, August 24, water service connection replacement work is scheduled to be carried out at locations No. 21 and No. 24, as shown in the diagram.\n\nAs part of the work, water service will need to be temporarily suspended for the affected households and businesses. Those affected will be notified individually in advance of the specific date and time of the water service suspension.\n\nRegarding traffic restrictions, the closure area will return to the section around the railway tracks. Through traffic will not be possible from either the north or the south. Drivers are kindly requested to use the designated detour routes.\n\nPlease note that the available routes for medium-sized vehicles will also be limited. We sincerely apologize for the inconvenience and kindly ask drivers to use the appropriate route according to their destination.\n\nWe apologize for the continued inconvenience caused to local residents. Under the guidance of the water authority, all parties involved will continue to work in close cooperation and proceed with the construction while giving the highest priority to safety. We sincerely appreciate your understanding and cooperation in ensuring the safe and smooth completion of the work.""",
