...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月12日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_description": "工事期間中は、皆様にご理解とご協力を賜り、誠にありがとうございます。おかげさまで、本日5月12日より配水管布設工を開始することができました。皆様のご協力により、現在のところ安全に作業を進めることができておりますこと、心より感謝申し上げます。\n\n明日5月13日は、本日の作業の続きとして、図に示しております箇所の施工を進めさせていただく予定です。工事に伴い、しばらくの間、北側からの車両の出入りができなくなります。\n\nまた、大型車両につきましては、恐れ入りますが、図に示しております箇所より進入していただけますと幸いです。迂回路につきましても道路幅が狭く、皆様にはご不便とご負担をおかけいたしますことを、心よりお詫び申し上げます。\n\n安全を最優先に、できる限り円滑に作業を進めてまいりますので、引き続き温かいご理解とご協力を賜りますようお願い申し上げます。\n\nなお、天候等の状況により、作業日程が変更となる場合がございますので、あらかじめご了承ください。",
