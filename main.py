...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　6月10日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "日頃より、本工事に対しましてご理解とご協力を賜り、誠にありがとうございます。\n\n工事期間中は、交通規制や迂回のお願いなどにより、地域の皆様にはご不便をおかけしておりますが、皆様の温かいご配慮に支えられながら作業を進めることができておりますこと、心より感謝申し上げます。\n\n本日の施工では、工事箇所周辺にお住まいの皆様に、お車を臨時駐車場へ移動していただくなど、普段以上のお手間とご負担をおかけいたしましたことをお詫び申し上げます。\n\nそのような中でも、工事の趣旨をご理解いただき、快くご協力くださいました皆様のおかげで、作業を円滑に進めることができました。皆様のご協力に深く感謝申し上げます。\n\n6月11日（木曜日）は、図に示しております箇所において、配水管布設工を行う予定としております。\n\nこれに伴い、通行規制区間につきましては、引き続き規制範囲を拡大する予定です。そのため、南側から北側への通り抜けは、引き続きご利用いただけない見込みとなっております。\n\nご迷惑をおかけいたしますが、お車で通行される際は、線路手前より迂回していただきますようお願いいたします。\n\nまた、現地では安全確保のため、交通誘導員を配置しております。通行の際は、交通誘導員の案内をご確認いただき、図面に記載しております迂回経路をご利用くださいますようお願いいたします。\n\nなお、北側からの車両の進入につきましても、引き続き制限を実施する予定としております。\n\n中型車両をご利用の場合は、恐れ入りますが、図面に記載しております指定の進入経路をご利用いただきますようお願いいたします。\n\n迂回路には見通しの悪い箇所や道幅の狭い箇所もございますので、通行の際は十分お気を付けください。\n\n工事の進捗に伴い、地域の皆様には長期間にわたりご不便をおかけしておりますことを、大変心苦しく感じております。\n\n今後も安全管理を徹底するとともに、生活環境への影響をできる限り抑えながら施工を進めてまいります。\n\n完成まで今しばらくご迷惑をおかけいたしますが、何卒ご理解とご協力のほどよろしくお願い申し上げます。",
