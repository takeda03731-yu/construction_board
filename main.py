...
SITE_INFO = {
    ...
    "image_description": "日頃より、本工事へのご理解とご協力を賜り、誠にありがとうございます。\n\n給水分岐替工に先立ち実施する舗装版切断工の日程が決まりましたので、改めてお知らせいたします。\n\n7月30日（木曜日）・31日（金曜日）に、舗装版切断工を実施いたします。\n\n作業中は、時間帯によって車両の通行が難しくなる場合がございます。現場には安全確保のため交通誘導員を配置いたしますので、通行の際は交通誘導員の案内に従っていただきますようお願いいたします。\n\nその後、8月3日（月曜日）から防護コンクリート養生の撤去および埋戻しを行い、8月4日（火曜日）から本格的に給水分岐替工を開始する予定です。\n\n給水分岐替工では、各ご家庭・事業所において個別に断水が発生いたします。断水の日時につきましては、対象となる皆様へ事前にお知らせいたしますので、ご理解とご協力をお願いいたします。\n\nまた、8月3日以降の工事では、北側・南側の両方で通行が制限される場合がございます。通行の際は、迂回路のご利用をご検討くださいますようお願いいたします。\n\n地域の皆様にはご不便をおかけいたしますが、安全に十分配慮して工事を進めてまいりますので、引き続きご理解とご協力を賜りますよう、よろしくお願い申し上げます。",
...
SITE_INFO_EN = {
    ...
    "image_description": """Thank you very much for your continued understanding and cooperation with the construction work.\n\nWe would like to inform you that the schedule has been determined for the pavement cutting work to be carried out before the water service connection replacement work.\n\nPavement cutting work will be conducted on Thursday, July 30, and Friday, July 31.\n\nDuring the work, vehicle access may be difficult at certain times. Traffic controllers will be stationed at the site to ensure safety. Please follow their instructions when passing through the area.\n\nAfterward, removal of the protective concrete curing materials and backfilling will begin on Monday, August 3. The full-scale water service connection replacement work is scheduled to begin on Tuesday, August 4.\n\nDuring the water service connection replacement work, individual homes and businesses will experience temporary water service interruptions. Those affected will be notified in advance of the date and time. We kindly ask for your understanding and cooperation.\n\nFrom August 3 onward, traffic restrictions may be implemented on both the north and south sides of the construction area. Please consider using the designated detour route when traveling through the area.\n\nWe apologize for any inconvenience this may cause. We will continue to carry out the work with the utmost attention to safety and sincerely appreciate your continued understanding and cooperation.""",
