...
SITE_INFO = {
    ...
    "image_description": "平素より、本工事の実施に際し、地域の皆様には温かいご理解とご協力をいただき、心より感謝申し上げます。\n\nこのたび、皆様のご協力のおかげをもちまして、給水分岐替工事を全箇所、無事に完了することができました。\n\n当初は完了までにもう少し期間を要することも想定しておりましたが、地域の皆様にご協力いただいたことで、工事を円滑に進めることができました。改めまして、心より御礼申し上げます。\n\n今後は、連絡管の接続工事および既設管の撤去工事を予定しております。これらの工事を開始するまでには、所定の手続きや準備作業が必要となるため、しばらくの間、休工といたします。\n\n工事の再開時期につきましては、決まり次第、できる限り早く掲示板にてお知らせいたします。\n\n地域の皆様には、引き続きご不便をおかけすることもございますが、今後の工事につきましても、安全を第一に進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
    ...
    "image_description4": "工事の進捗に伴い、9月8日（火曜日）以降は、工事業者によるゴミの移動を行いません。各ゴミステーションに出されたゴミは、それぞれの場所から通常どおり収集されます。\n\n地域の皆様に特別なご対応をお願いするものではございません。これまでどおり、所定の時間までに、普段ご利用のゴミステーションへゴミをお出しください。\n\n今後、工事の進捗により再びゴミの移動が必要となる場合は、事前にこの掲示板にてお知らせいたします。\n\n工事期間中は、地域の皆様にご不便をおかけすることもございますが、引き続き安全かつ円滑に工事を進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
    "holiday_notice": "今後予定しております連絡管の接続工事および既設管の撤去工事を開始するまでには、所定の手続きや準備作業が必要となるため、しばらくの間、休工といたします。工事の再開時期につきましては、決まり次第、掲示板にてお知らせいたします。\n\nまた、本工事では、作業員の安全確保と健康管理に加え、建設業界における働き方改革の取り組みの一環として、原則、土曜日および日曜日を休工日としております。\n\n近年、建設業界では、安全で質の高い施工を継続するため、適切な休日を確保しながら工事を進める取り組みが推進されています。本工事におきましても、特別な事情がない限り、土曜日および日曜日の作業は行わない予定です。\n\n地域の皆様には、休工によりご不便をおかけすることもございますが、安全かつ円滑に工事を進めるため、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。"
}
...
SITE_INFO_EN = {
    ...
    "image_description": """We would like to express our sincere appreciation to all local residents for your continued understanding and cooperation regarding this construction work.\n\nThanks to your cooperation, the water service connection replacement work has now been safely completed at all locations.\n\nWe initially anticipated that the work might take a little longer to complete. However, with the cooperation of local residents, we were able to carry out the work smoothly. We would once again like to express our heartfelt gratitude for your support.\n\nThe next stages of the project will include connecting pipeline work and the removal of the existing pipes. As the required procedures and preparations must be completed before this work can begin, construction will be temporarily suspended for some time.\n\nWe will provide an update on this notice board as soon as the date for resuming construction has been determined.\n\nWe apologize for any continued inconvenience this may cause. We will continue to give the highest priority to safety throughout the remaining work and sincerely appreciate your understanding and cooperation.""",
...
We will do our best to minimize inconvenience and appreciate your cooperation for safe construction work.""",
    ...
    "image_description4": """Due to the progress of the construction work, the construction contractor will no longer relocate garbage beginning Tuesday, September 8. Garbage placed at each collection point will be collected from its usual location.\n\nNo special action is required from local residents. Please continue to place your garbage at your usual collection point by the designated collection time.\n\nIf it becomes necessary to relocate garbage again due to the progress of the construction work, we will provide advance notice on this notice board.\n\nWe apologize for any inconvenience that may occur during the construction period. We will continue to carry out the work safely and smoothly, and we sincerely appreciate your understanding and cooperation.""",

    "holiday_notice": """Before the upcoming connecting pipeline work and removal of the existing pipes can begin, certain required procedures and preparations must be completed. Therefore, construction work will be temporarily suspended for some time. We will provide an update on this notice board as soon as the date for resuming construction has been determined.\n\nIn addition to ensuring the safety and well-being of our workers, Saturdays and Sundays are generally designated as non-working days for this project as part of work-style reform initiatives in the construction industry.\n\nIn recent years, the construction industry has been promoting initiatives to ensure that workers receive appropriate time off while continuing to provide safe, high-quality construction work. Accordingly, no work is generally scheduled on Saturdays or Sundays for this project unless special circumstances require otherwise.\n\nWe understand that the temporary suspension of work may cause some inconvenience to local residents. However, it is necessary to ensure that the construction work proceeds safely and smoothly. We sincerely appreciate your understanding and cooperation."""
}
