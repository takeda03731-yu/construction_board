...
SITE_INFO = {
    ...
    "image_description": "平素より、本工事の実施に際し、地域の皆様には温かいご理解とご協力をいただき、心より感謝申し上げます。\n\nこのたび、皆様のご協力のおかげをもちまして、給水分岐替工事を全箇所、無事に完了することができました。\n\n当初は完了までにもう少し期間を要することも想定しておりましたが、地域の皆様にご協力いただいたことで、工事を円滑に進めることができました。改めまして、心より御礼申し上げます。\n\n今後は、9月10日（木曜日）から、図に示した箇所より、連絡管の接続工事および既設管の撤去工事を開始する予定です。\n\n連絡管の接続工事では、既設の配水管を切断する必要があるため、図に示した地域において一時的な断水が発生いたします。断水の日時や対象範囲などの詳細につきましては、近日中に配布するチラシをご確認くださいますようお願いいたします。\n\nまた、工事に伴う交通規制につきましては、線路付近を含む範囲で実施いたします。北側・南側のいずれの方向からも、お車での通り抜けができませんので、付近を通行される際は、迂回路をご利用くださいますようお願いいたします。\n\n工事箇所周辺には、皆様の安全な通行を確保するため、交通誘導員を配置いたします。通行の際は、現地の案内看板および交通誘導員の誘導に従っていただきますよう、ご理解とご協力をお願いいたします。\n\n地域の皆様には、断水や交通規制により、引き続きご不便をおかけいたしますが、今後の工事につきましても安全を第一に進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
...
SITE_INFO_EN = {
    ...
    "image_description": """We would like to express our sincere appreciation to all local residents for your continued understanding and cooperation regarding this construction work.\n\nThanks to your cooperation, the water service connection replacement work has been safely completed at all locations.\n\nWe initially anticipated that the work might take a little longer to complete. However, with the cooperation of local residents, we were able to carry out the work smoothly. We would once again like to express our heartfelt gratitude for your support.\n\nBeginning Thursday, September 10, connecting pipeline work and the removal of the existing pipes are scheduled to begin at the location shown in the diagram.\n\nThe connecting pipeline work will require the existing water distribution main to be cut. Therefore, the water supply will be temporarily suspended in the area shown in the diagram. For details regarding the date, time, and affected area of the water service suspension, please refer to the notice that will be distributed shortly.\n\nTraffic restrictions will also be in place around the railway tracks during the work. Through traffic will not be possible from either the north or the south. Drivers travelling near the construction area are kindly requested to use the designated detour routes.\n\nTraffic control personnel will be stationed around the construction area to ensure everyone’s safety. When passing through the area, please follow the on-site signs and the directions given by the traffic control personnel.\n\nWe apologize for the continued inconvenience caused by the temporary water service suspension and traffic restrictions. We will continue to give the highest priority to safety throughout the remaining work and sincerely appreciate your understanding and cooperation.""",
