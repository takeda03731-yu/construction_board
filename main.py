...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　6月1日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "平素より、本工事につきまして、格別のご理解とご協力をいただき、誠にありがとうございます。\n\n工事期間中は、交通規制や迂回などにより、地域の皆様にご不便をおかけしておりますが、日々温かく見守っていただいておりますこと、心より感謝申し上げます。\n\n明日6月2日は、台風の影響により雨が見込まれるため、休工とさせていただきます。明後日6月3日（水曜日）は、図に示しております箇所において施工を予定しております。\n\n本日の施工に際しましては、㈱田宮パーツの皆様、大洋印刷㈱の皆様、ならびに施工箇所付近にお住まいの皆様には、車両の出入りや通行などにおいて、大変なご不便をおかけいたしました。また、断水の際には、皆様に多大なるご迷惑をおかけしましたこと、深くお詫び申し上げます。\n\nそのような中でも、皆様には作業へのご理解とご協力をいただき、おかげさまで本日の作業を進めることができました。また、今回の断水対応に際しましては、水道企業団の担当者の皆様にも迅速にご対応いただきました。\n\n急な対応が必要となる状況の中、関係各所との調整や現場対応にご尽力いただいたおかげで、大きな混乱や長時間の断水に至ることなく、本管の復旧を行うことができました。\n\n住民の皆様への影響を少しでも軽減できるよう、ご支援・ご協力をいただきましたこと、この場をお借りして心より御礼申し上げます。\n\nまた、地域の皆様におかれましても、急な断水や作業内容の変更に対し、温かくご理解いただきましたこと、深く感謝申し上げます。\n\n土曜日・日曜日の作業をできる限り避けながら工程を進めることができておりますのも、地域の皆様、関係各所の皆様のご理解とご協力によるものと感じております。引き続き、できる限りご負担を少なくできるよう努めてまいります。\n\n6月3日からの通行止め区間につきましては、工事の進捗状況により、一部延長となる可能性がございます。これに伴い、南側から北側への通り抜けは、引き続きできない見込みとなっております。皆様にはご不便をおかけいたしますが、通行の際は線路手前より迂回していただきますよう、ご理解とご協力をお願いいたします。\n\n通行の際は、現地誘導員の案内に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。なお、北側からの車両通行につきましても、引き続き制限が続く予定です。\n\n大型車両をご利用の方につきましては、恐れ入りますが、図に示しております箇所より進入していただきますようお願いいたします。\n\nまた、迂回路には道路幅が狭い箇所もございますので、通行の際は十分ご注意くださいますようお願いいたします。\n\n地域の皆様には、重ねてご不便とご負担をおかけいたしますが、安全を最優先に、周辺環境へ十分配慮しながら作業を進めてまいります。\n\n何卒ご理解とご協力を賜りますようお願い申し上げます。",
