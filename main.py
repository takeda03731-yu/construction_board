...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月29日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "日頃より、本工事にご理解とご協力を賜り、誠にありがとうございます。\n\n交通規制や迂回などにより、地域の皆様にはご不便をおかけしておりますが、皆様のご理解と温かいご協力に支えられ、安全に作業を進めることができております。心より御礼申し上げます。\n\n6月1日（月曜日）は、図に示しております箇所にて施工を予定しております。\n\n本日施工を行うにあたり、㈱田宮パーツの皆様、大洋印刷㈱の皆様、ならびに施工箇所付近にお住まいの皆様には、車両の出入りや通行などにおいて多大なるご不便とご負担をおかけいたしました。\n\nそのような状況にもかかわらず、皆様には温かくご理解いただき、作業へのご配慮とご協力を賜りましたこと、心より感謝申し上げます。\n\n皆様のご協力のおかげで、本日の作業も大きな支障なく、安全に進めることができました。\n\nまた、土曜日・日曜日の作業を避けながら工程を進めることができておりますのも、皆様のご理解とご協力があってこそと感じております。改めまして、深く御礼申し上げます。\n\n通行止め区間につきましては、引き続き一部延長となるため、南側から北側への通り抜けはできません。\n\n通行の際は、現地誘導員の案内に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。\n\nなお、北側からの車両通行につきましても、引き続き制限が続く予定です。\n\n大型車両をご利用の方につきましては、恐れ入りますが、図に示しております箇所より進入していただきますようお願いいたします。\n\nまた、迂回路には道路幅が狭い箇所もございますので、通行の際は十分ご注意くださいますようお願いいたします。\n\n皆様にはご不便とご負担をおかけいたしますが、安全を第一に作業を進めてまいりますので、何卒ご理解とご協力を賜りますようお願い申し上げます。\n\n今後も安全管理を徹底し、周辺環境に十分配慮しながら施工を進めてまいりますので、引き続きよろしくお願い申し上げます。",
