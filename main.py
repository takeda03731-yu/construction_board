...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　6月3日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "平素より、本工事につきまして格別のご理解とご協力をいただき、誠にありがとうございます。\n\n工事期間中は、交通規制や迂回などにより、地域の皆様にご不便をおかけしておりますが、日々温かく見守っていただいておりますこと、心より感謝申し上げます。\n\n明日6月4日（木曜日）は、図に示しております箇所において施工を予定しております。\n\n本日の施工におきまして、工事箇所付近の事業所様の駐車場内を工事車両により汚してしまう事案がございました。\n\n関係者の皆様には多大なるご迷惑をおかけしましたことを、深くお詫び申し上げます。\n\n今後は工事車両の運行管理および周辺環境への配慮をより一層徹底し、このようなことが二度と発生しないよう努めてまいります。\n\n6月4日からの通行止め区間につきましては、一部延長となる予定です。これに伴い、南側から北側への通り抜けは、引き続きできない見込みとなっております。\n\n皆様にはご不便をおかけいたしますが、通行の際は、線路手前より迂回していただきますようお願いいたします。\n\nまた、現地では誘導員の案内に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。なお、北側からの車両通行につきましても、引き続き制限が続く予定です。\n\n大型車両をご利用の方につきましては、恐れ入りますが、図に示しております箇所より進入していただきますようお願いいたします。\n\n迂回路には道路幅が狭い箇所もございますので、通行の際は十分ご注意くださいますようお願いいたします。\n\n地域の皆様には、重ねてご不便とご負担をおかけいたしますが、安全を最優先に、周辺環境へ十分配慮しながら作業を進めてまいります。\n\n何卒ご理解とご協力を賜りますようお願い申し上げます。",
