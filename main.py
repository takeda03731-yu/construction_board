...
SITE_INFO = {
    ...
    "image_description": "本日の断水に際しまして、地域の皆様にはご理解とご協力をいただき、誠にありがとうございました。\n\n作業中、皆様にはご不便をおかけする場面もございましたが、ご協力のおかげをもちまして、連絡工1箇所を無事に完了することができました。改めまして、心より御礼申し上げます。\n\n今回の連絡工により、既設の配水管と新設の配水管を接続し、配水管をループ化することができました。今後の水道施設の機能向上につながる重要な工程となります。\n\n明日9月11日（金曜日）は、図に示した箇所の連絡工を実施する予定です。\n\n連絡管の接続工事では、既設の配水管を切断する必要があるため、図に示した地域において一時的な断水が発生いたします。断水の日時や対象範囲などの詳細につきましては、別途配布するチラシをご確認くださいますようお願いいたします。\n\nまた、工事に伴う交通規制につきましては、線路付近を含む範囲で実施いたします。北側・南側のいずれの方向からも、お車での通り抜けができませんので、付近を通行される際は、迂回路をご利用くださいますようお願いいたします。\n\n工事箇所周辺には、皆様の安全な通行を確保するため、交通誘導員を配置いたします。通行の際は、現地の案内看板および交通誘導員の誘導に従っていただきますよう、ご理解とご協力をお願いいたします。\n\n地域の皆様には、断水や交通規制により、引き続きご不便をおかけいたしますが、今後の工事につきましても安全を第一に進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
    ...
    "image_description4": "本日の作業完了に伴い、工事業者が移動するゴミの対象範囲を縮小いたします。\n\n今後は、「ゴミステーション1」に出されたゴミのみ、工事業者が「移動先ゴミステーション1」まで移動いたします。その他のゴミステーションに出されたゴミにつきましては、それぞれの場所から通常どおり収集されます。\n\n地域の皆様に特別なご対応をお願いするものではございません。これまでどおり、所定の時間までに、普段ご利用のゴミステーションへゴミをお出しください。「ゴミステーション1」に出されたゴミの移動は、工事業者が行います。\n\n工事期間中は、地域の皆様にご不便をおかけすることもございますが、引き続き安全かつ円滑に工事を進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
...
SITE_INFO_EN = {
    ...
    "image_description": """We sincerely thank all local residents for your understanding and cooperation during today’s temporary water service suspension.\n\nAlthough there were some inconveniences during the work, your cooperation enabled us to safely complete the connecting pipeline work at one location. We would once again like to express our sincere appreciation.\n\nThrough today’s work, the existing water distribution main was connected to the newly installed water distribution main, creating a looped water distribution network. This was an important step toward improving the functionality of the water supply system.\n\nTomorrow, Friday, September 11, connecting pipeline work is scheduled to be carried out at the location shown in the diagram.\n\nThis work requires the existing water distribution main to be cut. Therefore, the water supply will be temporarily suspended in the area shown in the diagram. For details regarding the date, time, and affected area, please refer to the separately distributed notice.\n\nTraffic restrictions will also be in place around the railway tracks. Through traffic will not be possible from either the north or the south. Drivers travelling near the construction area are kindly requested to use the designated detour routes.\n\nTraffic control personnel will be stationed around the construction area to ensure everyone’s safety. When passing through the area, please follow the on-site signs and the directions given by the traffic control personnel.\n\nWe apologize for the continued inconvenience caused by the temporary water service suspension and traffic restrictions. We will continue to give the highest priority to safety throughout the remaining work and sincerely appreciate your understanding and cooperation.""",
...
We will do our best to minimize inconvenience and appreciate your cooperation for safe construction work.""",
    ...
    "image_description4": """Following the completion of today’s work, the area covered by the contractor’s garbage relocation service will be reduced.\n\nFrom now on, only garbage placed at “Garbage Collection Point 1” will be moved by the construction contractor to “Temporary Garbage Collection Point 1.” Garbage placed at the other collection points will be collected directly from their usual locations.\n\nNo special action is required from local residents. Please continue to place your garbage at your usual collection point by the designated collection time. The construction contractor will handle the relocation of garbage placed at “Garbage Collection Point 1.”\n\nWe apologize for any inconvenience during the construction period. We will continue to carry out the work safely and smoothly, and we sincerely appreciate your understanding and cooperation.""",
