...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　6月8日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "交通規制や迂回などによりご不便をおかけしておりますが、地域の皆様の温かいご協力のおかげで、安全に工事を進めることができております。心より御礼申し上げます。\n\n本日の作業におきましては、㈱田宮パーツの皆様、大洋印刷㈱の皆様にご不便をおかけいたしました。\n\n事前のご説明が十分でないまま作業を行う形となり、ご迷惑をおかけしましたことを、この場をお借りしてお詫び申し上げます。今後は、作業内容や影響範囲をより慎重に確認し、必要なご説明を事前に行うよう努めてまいります。\n\n6月9日（火曜日）は、図に示しております箇所において、配水管布設工を実施する予定としております。\n\nこれに伴い、通行止め区間につきましては、再び規制範囲が延長となる予定です。南側から北側への通り抜けは、引き続きできない状況となります。\n\nお手数をおかけいたしますが、通行の際は、線路手前より迂回していただきますようお願いいたします。\n\nまた、現地では皆様の安全な通行をサポートするため、交通誘導員がご案内いたします。誘導に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。\n\nなお、北側からの車両通行につきましても、引き続き制限が続く予定です。\n\n大型車両をご利用の皆様につきましては、恐れ入りますが、図に示しております進入経路をご利用くださいますようお願いいたします。\n\n迂回路には道路幅が狭い箇所もございますので、通行の際は十分ご注意くださいますようお願いいたします。\n\n地域の皆様には、長期間にわたりご不便とご負担をおかけしておりますことをお詫び申し上げます。作業にあたっては安全を最優先とし、周辺環境にも十分配慮しながら進めてまいります。\n\n引き続き、ご理解とご協力を賜りますようお願い申し上げます。",
