...
SITE_INFO = {
    ...
    "image_description": "平素より、本工事に対しまして、地域の皆様にはご理解とご協力をいただき、誠にありがとうございます。\n\nみなさまのご協力のおかげをもちまして、撤去・連絡工が全箇所終了いたしました。重ねて御礼申し上げます。\n\n今後は、道路管理者立会のもと本工事の舗装範囲を決定し、それをもとに舗装版切断工を実施いたします。その後、最終工程となる本舗装復旧工を開始する予定でございます。\n\n地域の皆様には、工事や交通規制により引き続きご不便をおかけいたしますが、安全を最優先に作業を進めてまいりますので、工事完了まで何卒ご理解とご協力を賜りますよう、お願い申し上げます。",
    ...
    "image_description4": "撤去・連絡工が全箇所完了いたしましたので、当分の間、ゴミの移動は致しません。\n\nこれまでどおり所定の時間までにゴミをお出しいただければ、通常どおりゴミステーションより収集されますので、ご安心ください。\n\n工事期間中は、地域の皆様にご不便をおかけすることもございますが、引き続き安全かつ円滑に工事を進めてまいりますので、何卒ご理解とご協力を賜りますようお願い申し上げます。",
    "holiday_notice": "撤去・連絡工が完了いたしましたので、本舗装復旧工の舗装版切断まで、休工とさせていただきます。舗装版切断工の開始日が判明いたしましたら、掲示板にてお知らせいたします。\n\n本工事では、作業員の安全と健康を守り、適切な休日を確保するため、原則として土曜日・日曜日を休工日とさせていただいております。特別な事情がない限り、土曜日・日曜日の作業は行わない予定でございます。\n\n地域の皆様には、工事期間中ご不便をおかけいたしますが、安全に工事を進めてまいりますので、引き続きご理解とご協力をお願いいたします。"
}

SITE_INFO_EN = {
    "construction_name": "FY2025 Water Pipeline Renewal (Seismic Reinforcement) Project, Doyomaru (Koreishi) District and Other Areas\nWater Distribution Pipe Replacement Work Notice Board, as of September 25",
    "image_file": "撤去・連絡工en.pdf",
    "image_file2": "工事概要en.pdf",
    "image_file3": "臨時駐車場en.pdf",
    "image_file4": "ゴミの移動en.pdf",

    "image_description": """We would like to sincerely thank the local community for your continued understanding and cooperation regarding this construction project.\n\nThanks to your cooperation, the removal and connection work has now been completed at all locations. We would like to express our gratitude once again.\n\nGoing forward, the paving area for this project will be determined in consultation with the road administrator, and pavement cutting work will be carried out based on that determination. After that, the final stage of the project, final pavement restoration work, is scheduled to begin.\n\nWe apologize for the continued inconvenience caused by the construction work and traffic restrictions. We will continue to give the highest priority to safety as we carry out the work, and we appreciate your understanding and cooperation until the project is completed.""",
