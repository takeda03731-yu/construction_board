...
SITE_INFO = {
    ...
    "image_description": "本日の断水に備えてご準備いただきました皆様には、ご理解とご協力を賜り、誠にありがとうございました。\n\n本日予定しておりました断水作業につきまして、降雨による現場状況を確認した結果、安全な掘削作業の実施や、埋戻し後に必要な強度を確保することが難しいと判断されました。このため、水道企業団との協議の結果、本日の断水作業を中止いたしました。\n\n事前にご準備いただいたにもかかわらず、当日の中止となり、対象となるご家庭および事業所の皆様には、多大なるご迷惑をおかけしましたことを深くお詫び申し上げます。\n\n今回中止となった断水作業は、9月24日（木曜日）以降に延期する予定です。実施日時が決まり次第、改めてチラシを配布してお知らせいたしますので、何卒ご理解とご協力をお願いいたします。\n\n明日9月15日（火曜日）は、図に示した箇所において、既設管の閉栓工および撤去工を実施する予定です。\n\nなお、明日の工事に伴う断水はございません。ご家庭および事業所の水道は、通常どおりご使用いただけます。\n\n既設管の閉栓工および撤去工が完了しましたら、最終工程となる本舗装を行い、本工事は完了する予定です。工事完了まであとわずかとなりましたが、引き続きご理解とご協力をお願いいたします。\n\n当日の交通規制は、工事区間の北側を中心とした範囲で実施いたします。工事箇所を通り抜けることはできませんので、付近を通行される際は、案内図に示す迂回路をご利用くださいますようお願いいたします。\n\nまた、工事箇所周辺には、皆様の安全な通行を確保するため、交通誘導員を配置いたします。現地を通行される際は、案内看板をご確認のうえ、交通誘導員の誘導に従っていただきますようお願いいたします。\n\n地域の皆様には、工事や交通規制により引き続きご不便をおかけいたしますが、関係者一同、安全を最優先に作業を進めてまいります。工事の円滑な実施に向け、今後ともご理解とご協力を賜りますようお願い申し上げます。",
...
SITE_INFO_EN = {
    ...
    "image_description": """We sincerely thank all households and businesses affected by today’s planned water service suspension for your understanding and cooperation in making the necessary preparations.\n\nAfter assessing the site conditions caused by the rain, it was determined that safely carrying out the excavation work and ensuring the required strength after backfilling would be difficult. Therefore, following discussions with the water authority, today’s planned water service suspension and associated work were cancelled.\n\nWe deeply apologize to the affected households and businesses for the inconvenience caused by this same-day cancellation, particularly after you had already made the necessary preparations.\n\nThe cancelled work is expected to be rescheduled for Thursday, September 24, or a later date. Once the new date and time have been determined, we will distribute another notice with further details. We sincerely appreciate your understanding and cooperation.\n\nTomorrow, Tuesday, September 15, closure and removal work on the existing pipes is scheduled to be carried out at the location shown in the diagram.\n\nPlease note that tomorrow’s work will not require a water service suspension. Households and businesses may use their water supply as usual.\n\nOnce the closure and removal work on the existing pipes has been completed, the final stage will be permanent road paving. This will complete the entire construction project. Only a small amount of work remains, and we sincerely appreciate your continued understanding and cooperation.\n\nTraffic restrictions will be in place mainly on the northern side of the construction area. Vehicles will not be able to pass through the work area. Drivers travelling nearby are kindly requested to use the detour route shown on the map.\n\nTraffic control personnel will be stationed around the construction area to ensure everyone’s safety. When passing through the area, please check the on-site signs and follow the directions given by the traffic control personnel.\n\nWe apologize for the continued inconvenience caused by the construction work and traffic restrictions. All parties involved will continue to give the highest priority to safety. We sincerely appreciate your continued understanding and cooperation in ensuring that the remaining work proceeds smoothly.""",
