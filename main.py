...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月22日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_description": "工事期間中は、交通規制や迂回などによりご不便をおかけしておりますが、地域の皆様には温かいご理解とご協力をいただき、誠にありがとうございます。\n\n皆様のご協力のおかげで、現在のところ安全に作業を進めることができております。心より感謝申し上げます。\n\n土日連休明けの5月25日（月曜日）は、大きな天候の変化もない見込みのため、図に示しております箇所の施工を予定しております。\n\nこれに伴い、通行止めの範囲が引き続き一部延長となり、南側から北側への通り抜けができなくなります。\n\n通行の際は、現地係員の案内に従って、図に示しております迂回路をご利用いただきますようお願いいたします。\n\nまた、北側からの車両の通り抜けにつきましても、引き続きできなくなりますので、あらかじめご了承いただきますようお願いいたします。\n\n大型車両につきましては、恐れ入りますが、図に示しております箇所より進入していただきますようお願いいたします。\n\nなお、迂回路につきましても道路幅が狭くなっておりますため、皆様にはご不便とご負担をおかけいたしますことを、心よりお詫び申し上げます。\n\n安全を最優先に、できる限り円滑に作業を進めてまいりますので、引き続きご理解とご協力を賜りますよう、よろしくお願い申し上げます。",
