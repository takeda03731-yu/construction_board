...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　6月9日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "交通規制や迂回などによりご不便をおかけしておりますが、地域の皆様には日頃より温かいご理解とご協力をいただき、誠にありがとうございます。\n\n6月10日（水曜日）は、図に示しております箇所において、配水管布設工を実施する予定としております。\n\n明日の作業では、付近にお住まいの皆様の出入口付近を施工することとなります。対象となるお宅の皆様には、臨時駐車場へのお車の移動など、大変なご不便とご負担をおかけいたしますことを、心よりお詫び申し上げます。\n\nまた、ご不便をおかけする中で、工事にご理解いただき、臨時駐車場のご利用にご協力してくださる方に、深く感謝申し上げます。\n\nまた、通行止め区間につきましては、再び規制範囲を延長する予定としております。そのため、南側から北側への通り抜けは、引き続きできない状況となります。\n\nお手数をおかけいたしますが、通行の際は線路手前より迂回していただきますようお願いいたします。\n\nまた、現地では皆様の安全確保のため、交通誘導員がご案内いたします。お手数をおかけいたしますが、誘導員の案内に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。\n\nなお、北側からの車両通行につきましても、引き続き制限が続く予定です。\n\n大型車両をご利用の皆様につきましては、恐れ入りますが、図に示しております進入経路をご利用くださいますようお願いいたします。\n\n迂回路には道路幅が狭い箇所もございますので、通行の際は十分ご注意くださいますようお願いいたします。\n\n地域の皆様には、長期間にわたりご不便とご負担をおかけしておりますことを、改めてお詫び申し上げます。作業にあたっては安全を最優先とし、周辺環境にも十分配慮しながら進めてまいります。\n\n引き続き、ご理解とご協力を賜りますようお願い申し上げます。",
