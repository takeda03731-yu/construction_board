...
SITE_INFO = {
    ...
    "image_description": "本日の断水作業にあたり、地域の皆様には多大なるご理解とご協力を賜り、厚く御礼申し上げます。\n\n皆様のご協力により、本日予定しておりました連絡工1箇所を無事に終えることができました。断水にご協力いただきました皆様に、改めて深く感謝申し上げます。\n\n今回の作業をもちまして、既設の配水管と新設の配水管の接続が完了し、本工事で計画していた配水管のループ化をすべて完了することができました。今後の水道施設の機能向上に向けた、大切な工程が完了したことになります。\n\n9月12日（土曜日）および13日（日曜日）は、休工といたします。\n\n次回は、9月14日（月曜日）に、図に示した箇所において、既設管の閉栓工および撤去工を行う予定です。\n\n閉栓工では、不要となる仕切弁を撤去するため、図に示した地域の水道を一時的に停止いたします。断水の時間や対象範囲などの詳しい内容につきましては、別途配布するチラシをご確認ください。\n\n既設管の閉栓工および撤去工が完了しましたら、最終工程となる本舗装を行い、本工事は完了する予定です。工事完了まであと少しとなりましたが、引き続きご理解とご協力をお願いいたします。\n\n当日の交通規制は、工事区間の北側を中心とした範囲で実施いたします。北側・南側ともに、引き続きお車での通り抜けはできません。付近を通行される皆様にはご不便をおかけいたしますが、案内図に示す迂回路をご利用くださいますようお願いいたします。\n\nまた、工事箇所の周辺には、安全な通行を確保するため、交通誘導員を配置いたします。現地を通行される際は、案内看板をご確認のうえ、交通誘導員の指示に従っていただきますようお願いいたします。\n\n断水や交通規制により、地域の皆様には引き続きご負担をおかけいたします。関係者一同、安全の確保を最優先に作業を進めてまいりますので、今後ともご理解とご協力を賜りますようお願い申し上げます。",
    ...
    "image_description4": "本日の作業完了に伴い、工事業者によるゴミの移動は、いったん終了いたします。\n\n今後は、これまでどおり、所定の時間までに普段ご利用のゴミステーションへゴミをお出しください。各ゴミステーションに出されたゴミは、それぞれの場所から通常どおり収集されます。\n\n今後、工事の進捗により、再びゴミの移動が必要となる場合は、事前にこの掲示板にてお知らせいたします。\n\n工事期間中は、地域の皆様にご不便をおかけすることもございますが、引き続き安全かつ円滑に工事を進めてまいりますので、何卒ご理解とご協力をお願い申し上げます。",
    "holiday_notice": "本工事では、作業員の安全確保と健康管理に加え、建設業界における働き方改革の取り組みの一環として、原則、土曜日および日曜日を休工日としております。\n\n近年、建設業界では、安全で質の高い施工を継続するため、適切な休日を確保しながら工事を進める取り組みが推進されています。本工事におきましても、特別な事情がない限り、土曜日および日曜日の作業は行わない予定です。\n\n地域の皆様には、休工によりご不便をおかけすることもございますが、安全かつ円滑に工事を進めるため、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。"
}
...
SITE_INFO_EN = {
    ...
    "image_description": """We would like to express our sincere gratitude to all local residents for your understanding and cooperation during today’s temporary water service suspension.\n\nThanks to your cooperation, we were able to safely complete the connecting pipeline work scheduled at one location today. We once again extend our sincere appreciation to everyone affected by the water service suspension.\n\nWith the completion of today’s work, the existing water distribution mains have been connected to the newly installed water mains, completing all of the loop connections planned as part of this project. This marks the completion of an important stage in improving the water supply system.\n\nConstruction work will be suspended on Saturday, September 12, and Sunday, September 13.\n\nOn Monday, September 14, closure and removal work on the existing pipes is scheduled to be carried out at the location shown in the diagram.\n\nDuring the closure work, valves that are no longer required will be removed. As a result, the water supply will be temporarily suspended in the area shown in the diagram. For details regarding the time and affected area, please refer to the separately distributed notice.\n\nOnce the closure and removal work on the existing pipes has been completed, the final stage will be permanent road paving. This will complete the entire construction project. Only a small amount of work remains, and we sincerely appreciate your continued understanding and cooperation.\n\nTraffic restrictions will be in place mainly on the northern side of the construction area. Through traffic will remain unavailable from either the north or the south. We apologize for the inconvenience and kindly ask drivers travelling near the area to use the detour route shown on the map.\n\nTraffic control personnel will be stationed around the construction area to ensure everyone’s safety. When passing through the area, please check the on-site signs and follow the directions given by the traffic control personnel.\n\nWe apologize for the continued inconvenience caused by the temporary water service suspension and traffic restrictions. All parties involved will continue to give the highest priority to safety throughout the remaining work. We sincerely appreciate your continued understanding and cooperation.""",
...
We will do our best to minimize inconvenience and appreciate your cooperation for safe construction work.""",
    ...
    "image_description4": """Following the completion of today’s work, the temporary relocation of garbage by the construction contractor will be suspended for the time being.\n\nPlease continue to place your garbage at your usual collection point by the designated collection time. Garbage placed at each collection point will be collected directly from its usual location.\n\nIf it becomes necessary to relocate garbage again due to the progress of the construction work, we will provide advance notice on this notice board.\n\nWe apologize for any inconvenience during the construction period. We will continue to carry out the work safely and smoothly, and we sincerely appreciate your understanding and cooperation.""",

    "holiday_notice": """In addition to ensuring the safety and well-being of our workers, Saturdays and Sundays are generally designated as non-working days for this project as part of work-style reform initiatives in the construction industry.\n\nIn recent years, the construction industry has been promoting initiatives to ensure that workers receive appropriate time off while continuing to provide safe, high-quality construction work. Accordingly, no work is generally scheduled on Saturdays or Sundays for this project unless special circumstances require otherwise.\n\nWe understand that the suspension of work may cause some inconvenience to local residents. However, it is necessary to ensure that the construction work proceeds safely and smoothly. We sincerely appreciate your understanding and cooperation."""
}
