...
SITE_INFO = {
    ...
    "image_description": "舗装版切断工の際は、皆様にご理解とご協力を賜り、誠にありがとうございました。おかげさまで、無事故で円滑に作業を終えることができました。\n\n引き続き、5月11日より配水管布設工を開始させていただきます。作業は、図に示しております箇所の北側より、順次進めてまいります。\n\n工事に伴い、しばらくの間、北側からの車両の出入りができなくなります。また、迂回路につきましても道路幅が狭く、皆様にはご不便とご負担をおかけいたしますこと、心よりお詫び申し上げます。\n\n安全で円滑な工事のため、引き続きご理解とご協力のほど、よろしくお願いいたします。",
