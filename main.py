...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月1日現在",
    "image_file": "試掘工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_description": "舗装版切断工の際は、皆様にご理解とご協力を賜り、誠にありがとうございました。\n\nおかげさまで、無事故で円滑に作業を終えることができました。\n\n当初は配水管布設工を予定しておりましたが、施工に先立ち確認が必要となったため、作業内容を変更し、5月11日に試掘工を実施させていただくこととなりました。\n\n直前での変更となり、皆様にはご迷惑をおかけいたしますことをお詫び申し上げます。\n\n作業は、図に示しております2箇所で行う予定です。\n\n試掘に伴い、しばらくの間、北側からの車両の出入りができなくなる時間帯があります。また、試掘工①から作業を行い、①の箇所を埋め戻した後、試掘工②の作業に移ります。\n\n時間帯により規制箇所が①・②で変わりますので、あらかじめご了承ください。\n\n迂回路につきましても道路幅が狭く、皆様にはご不便とご負担をおかけいたしますことを、心よりお詫び申し上げます。安全を最優先に、できる限り円滑に作業を進めてまいりますので、引き続きご理解とご協力をいただけますと幸いです。",
