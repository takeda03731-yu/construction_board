...
SITE_INFO_EN = {
    "construction_name": "Notice Board for Water Distribution Pipe Replacement Work as of August 24, 2026",
    "image_file": "給水分岐替工en.pdf",
    "image_file2": "工事概要en.pdf",
    "image_file3": "臨時駐車場en.pdf",
    "image_file4": "ゴミの移動en.pdf",

    "image_description": """We would like to express our sincere gratitude to all local residents for your continued understanding and cooperation regarding this construction work.\n\nOn Tuesday, August 25, water service connection replacement work at location No. 23 and connecting pipeline installation work are scheduled to be carried out, as shown in the diagram.\n\nAs part of the work, water service will need to be temporarily suspended for the affected households and businesses. Those affected will be notified individually in advance of the specific date and time of the water service suspension.\n\nThe connecting pipeline installation work requires the existing water distribution main to be temporarily cut in order to connect it to the newly installed water distribution main. Therefore, water service will be temporarily suspended in the area shown in the diagram.\n\nWe sincerely apologize for the inconvenience caused to those affected. Under the supervision of a representative from the water authority, the workers and other parties involved will carry out the work with careful attention to safety. We will make every effort to complete the connection work and restore the water supply as quickly as possible. We kindly ask for your understanding and cooperation.\n\nRegarding traffic restrictions, the closure area will return to the previous arrangement. Through traffic will not be possible from either the north or the south. Drivers are kindly requested to use the designated detour routes.\n\nPlease note that the available routes for medium-sized vehicles will also be limited. We sincerely apologize for the inconvenience and kindly ask drivers to use the appropriate route according to their destination.\n\nWe apologize for the continued inconvenience caused to local residents. Under the guidance of the water authority, all parties involved will work in close cooperation and proceed with the construction while giving the highest priority to safety. We sincerely appreciate your understanding and cooperation in ensuring the safe and smooth completion of the work.""",
