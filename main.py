...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　8月19日現在",
    "image_file": "給水分岐替工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "日頃より、本工事の実施に際し、地域の皆様には多大なるご理解とご協力を賜り、心より御礼申し上げます。\n\n本日予定しておりました給水分岐替工事につきましては、給水管の状況が当初の想定と異なっていたため、施工を行うことができませんでした。工事を予定しておりました関係者の皆様には、ご迷惑をおかけしましたことを深くお詫び申し上げます。\n\n現地において、水道企業団の担当者の方に立ち会っていただき、今後の施工方法について慎重に確認・協議を行いました。その結果、安全性および適切な施工を確保するためには、新たに口径50mmの管を布設する必要があると判断され、本日の給水分岐替工事は見送ることとなりました。\n\n今後は、水道企業団の担当者の方のご指導のもと、必要な設計変更を進め、使用する材料がそろい次第、改めて工事を実施する予定です。施工日程が決まりましたら、対象となる皆様へできる限り早めにお知らせいたします。\n\nなお、明日8月20日（木曜日）は、図に示した給水分岐替工事箇所の「16番」および「22番」を施工する予定です。\n\n工事に伴い、対象となるご家庭・事業所におきましては、一時的に断水させていただく必要がございます。具体的な断水日時につきましては、対象となる皆様へ事前に個別でお知らせいたします。\n\nまた、工事の進捗に伴い、車両通行止めの範囲が拡大しているため、北側・南側のいずれの方向からも通り抜けができません。お車で通行される際は、迂回路をご利用くださいますようお願いいたします。\n\nなお、中型車両につきましても、通行可能な経路が限られております。ご不便をおかけして誠に申し訳ございませんが、目的地に応じた適切な経路をご利用くださいますようお願いいたします。\n\n地域の皆様には、引き続きご不便とご迷惑をおかけいたしますが、水道企業団と緊密に連携し、安全を最優先に工事を進めてまいります。工事の安全かつ円滑な実施に向け、何卒ご理解とご協力を賜りますよう、よろしくお願い申し上げます。",
...
SITE_INFO_EN = {
    ...
    "image_description": """We would like to express our sincere gratitude to all local residents for your continued understanding and cooperation regarding this construction work.\n\nThe water service connection replacement work scheduled for today could not be carried out because the condition of the existing water service pipe differed from what had originally been anticipated. We sincerely apologize to everyone affected for the inconvenience caused.\n\nA representative of the water authority kindly attended the site, and the appropriate construction method was carefully reviewed and discussed. As a result, it was determined that a new 50 mm diameter pipe must be installed to ensure the safety and proper execution of the work. Therefore, today’s water service connection replacement work was postponed.\n\nUnder the guidance of the water authority, the necessary design changes will now be made, and the work will be rescheduled once the required materials are available. We will notify those affected as soon as possible after the new construction date has been determined.\n\nTomorrow, Thursday, August 20, water service connection replacement work is scheduled to be carried out at locations No. 16 and No. 22, as shown in the diagram.\n\nAs part of the work, water service will need to be temporarily suspended for the affected households and businesses. Those affected will be notified individually in advance of the specific date and time of the water service suspension.\n\nDue to the progress of the construction work, the road closure area has been expanded, and through traffic is not possible from either the north or the south. Drivers are kindly requested to use the designated detour routes.\n\nPlease note that the available routes for medium-sized vehicles are also limited. We sincerely apologize for the inconvenience and kindly ask drivers to use the appropriate route according to their destination.\n\nWe apologize for the continued inconvenience caused to local residents. We will continue to work closely with the water authority and proceed with the construction while giving the highest priority to safety. We sincerely appreciate your understanding and cooperation in ensuring the safe and smooth completion of the work.""",
