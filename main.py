...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月26日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_description": "日頃より、工事へのご理解とご協力をいただき、誠にありがとうございます。\n\n交通規制や迂回などにより、地域の皆様にはご不便をおかけしておりますが、温かいご配慮をいただきながら作業を進めることができておりますこと、深く感謝申し上げます。\n\n5月27日（水曜日）は、降雨の可能性が高いことから、安全面等を考慮し、協議のうえ休工とさせていただきました。\n\nなお、明後日5月28日（木曜日）は、図に示しております箇所において施工を行う予定としております。\n\nこれに伴い、通行止め区間が引き続き一部延長となるため、南側から北側への通り抜けができなくなります。\n\n通行の際は、現地誘導員の案内に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。\n\nまた、北側からの車両の通り抜けにつきましても、引き続きできない状況となりますので、あらかじめご了承いただけますと幸いです。\n\n大型車両につきましては、恐れ入りますが、図に示しております箇所から進入していただきますようお願いいたします。\n\n迂回路につきましても道路幅が狭くなっておりますため、皆様にはご不便をおかけいたしますが、安全確保のため、ご理解とご協力をお願いいたします。\n\n今後も安全管理を徹底し、周辺環境に十分配慮しながら作業を進めてまいりますので、引き続きよろしくお願い申し上げます。",
