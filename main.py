...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　5月20日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_description": "日頃より、本工事へのご理解とご協力をいただき、誠にありがとうございます。\n\n交通規制や迂回などによりご不便をおかけしている中、皆様のご協力のおかげで、安全に作業を進めることができております。心より感謝申し上げます。\n\n本日5月20日は天候不良が予想されたため、協議のうえ、作業を中止とさせていただきました。\n\n朝の時点では雨予報となっていたため、安全面や作業状況などを踏まえて判断しておりますが、その後、実際の天気と予報に差が出る場合もございます。ご理解いただけますと幸いです。\n\n明日5月21日は、前回の続きとして、図に示しております三叉路付近の工事を行う予定としております。\n\nただし、現在の天気予報では5月21日も雨予報となっておりますため、天候の状況によっては作業を延期し、5月22日頃より工事を再開させていただく可能性がございます。\n\nなお、当日午前8時30分の時点で作業を開始していない場合は、雨天等により当日の作業を中止しておりますので、あらかじめご了承ください。\n\n工事を実施する場合は、通行止めの範囲が引き続き一部延長となり、南側から北側への通り抜けができなくなります。\n\n皆様にはお手数をおかけいたしますが、通行の際は、現地係員の案内に従って、図に示しております迂回路をご利用いただきますようお願いいたします。\n\nまた、北側からの車両の通り抜けにつきましても、引き続きできなくなりますので、あらかじめご了承ください。\n\n大型車両につきましては、恐れ入りますが、図に示しております箇所より進入していただきますようお願いいたします。\n\nなお、迂回路につきましても道路幅が狭く、皆様にはご不便とご負担をおかけいたしますことを、心よりお詫び申し上げます。\n\n安全を最優先に、できる限り円滑に作業を進めてまいりますので、引き続きご理解とご協力を賜りますようお願い申し上げます。",
