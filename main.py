...
# -------------------------
SITE_INFO = {
    "construction_name": "令和7年度 管路更新（耐震化）事業　土与丸（是石）地区ほか配水管布設替工事掲示板　6月5日現在",
    "image_file": "配水管布設工.pdf",  # staticフォルダ内のファイル名
    "image_file2": "工事概要.pdf",
    "image_file3": "臨時駐車場.pdf",
    "image_file4": "ゴミの移動.pdf",
    "image_description": "日頃より、本工事へのご理解とご協力を賜り、誠にありがとうございます。\n\n工事期間中は、交通規制や迂回などによりご不便をおかけしておりますが、皆様の温かいご協力のおかげで、安全に工事を進めることができております。心より御礼申し上げます。\n\n6月8日（月曜日）は、図に示しております箇所において、今後の施工に向けた現地確認および墨出し作業等を行う予定としております。\n\nこれに伴い、通行止め区間につきましては、少し前の規制に戻ります。南側から北側への通り抜けは、引き続きできない状況となります。\n\nお手数をおかけいたしますが、通行の際は線路手前より迂回していただきますようお願いいたします。\n\nまた、現地では皆様の安全な通行をサポートする交通誘導員がご案内いたしますので、誘導に従っていただき、図に記載しております迂回路をご利用くださいますようお願いいたします。なお、北側からの車両通行につきましても、引き続き制限が続く予定です。\n\n大型車両をご利用の皆様につきましては、恐れ入りますが、図に示しております進入経路をご利用くださいますようお願いいたします。\n\n迂回路には道路幅が狭い箇所もございますので、通行の際は十分ご注意くださいますようお願いいたします。\n\n地域の皆様には長期間にわたりご不便とご負担をおかけしておりますことをお詫び申し上げます。作業にあたっては安全を最優先とし、周辺環境にも十分配慮しながら進めてまいります。\n\n引き続き、ご理解とご協力を賜りますようお願い申し上げます。",
